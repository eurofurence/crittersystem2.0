...
final class GoodieItemController extends AbstractController
{
    ...
    #[Route('/{id}/edit', name: 'app_backstage_goodie_item_edit', methods: ['GET', 'POST'], requirements: ['id' => '\d+'])]
    public function edit(Request $request, GoodieItem $item): Response
    {
        $form = $this->createForm(GoodieItemType::class, $item);
        $form->handleRequest($request);
    ...
    #[Route('/{id}/delete', name: 'app_backstage_goodie_item_delete', methods: ['POST'], requirements: ['id' => '\d+'])]
    public function delete(Request $request, GoodieItem $item): Response
    {
